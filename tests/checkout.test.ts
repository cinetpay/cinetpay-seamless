...
describe('Checkout', () => {
  ...
  it('creates overlay with waiting screen', () => {
    mockWindowOpen()
    const checkout = new Checkout({ logger: noopLogger, emitter, popupWidth: 500, popupHeight: 700 })
  ...
  it('calls onReady when popup opens', () => {
    mockWindowOpen()
    const onReady = vi.fn()
    const checkout = new Checkout({ logger: noopLogger, emitter, popupWidth: 500, popupHeight: 700, onReady })
    checkout.open('https://secure.cinetpay.net/checkout/token')
  ...
  it('calls onError when popup is blocked', () => {
    ...
    const onError = vi.fn()
    const checkout = new Checkout({ logger: noopLogger, emitter, popupWidth: 500, popupHeight: 700, onError })
    checkout.open('https://secure.cinetpay.net/checkout/token')
  ...
  it('calls onClose after close', () => {
    ...
    const onClose = vi.fn()
    mockWindowOpen()
    const checkout = new Checkout({ logger: noopLogger, emitter, popupWidth: 500, popupHeight: 700, onClose })
    checkout.open('https://secure.cinetpay.net/checkout/token')
    checkout.close()
  ...
  it('handles postMessage ACCEPTED from popup', () => {
    ...
    const checkout = new Checkout({ logger: noopLogger, emitter, popupWidth: 500, popupHeight: 700, onPaymentSuccess })
    checkout.open('https://secure.cinetpay.net/checkout/token')
  ...
  it('handles postMessage REFUSED from popup', () => {
    ...
    const checkout = new Checkout({ logger: noopLogger, emitter, popupWidth: 500, popupHeight: 700, onPaymentFailed })
    checkout.open('https://secure.cinetpay.net/checkout/token')
  ...
  it('handles postMessage PENDING from popup', () => {
    ...
    const checkout = new Checkout({ logger: noopLogger, emitter, popupWidth: 500, popupHeight: 700, onPaymentPending })
    checkout.open('https://secure.cinetpay.net/checkout/token')
  ...
  it('does not duplicate styles on multiple opens', () => {
    mockWindowOpen()
    const c1 = new Checkout({ logger: noopLogger, emitter, popupWidth: 500, popupHeight: 700 })
    c1.open('https://secure.cinetpay.net/checkout/token1')
    const c2 = new Checkout({ logger: noopLogger, emitter, popupWidth: 500, popupHeight: 700 })
